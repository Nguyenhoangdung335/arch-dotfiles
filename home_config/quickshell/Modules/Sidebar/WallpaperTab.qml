...
// Wallpaper selection tab with smooth entrance animations
Item {
    id: root
    ...
    // ✨ IMPROVED: Staggered entrance animation
    ...
    ColumnLayout {
        ...
        // --- Directory selector with slide animation ---
        Rectangle {
            ...
            RowLayout {
                ...
                Text {
                    Layout.fillWidth: true
                    text: shortenPath(Cfg.Theme.wallpaperDir)
                    color: Th.Theme.fg
                    font.pixelSize: 13
                    elide: Text.ElideMiddle
                }
                
                // ✨ IMPROVED: Animated refresh button
                Rectangle {
                    implicitWidth: 28
                    implicitHeight: 28
                    radius: 14
        ...
        // ✨ IMPROVED: Count with slide animation
        Text {
        ...
        // --- Wallpaper Grid with staggered entrance ---
        GridView {
            id: wallpaperGrid
            Layout.fillWidth: true
            ...
            // ✨ IMPROVED: Staggered delegate appearance
            delegate: WallpaperCard {
                ...
                onClicked: setWallpaper(model.path)
            }
    ...
    // --- Path Edit Dialog with animations ---
    Popup {
        id: pathDialog
        ...
        // ✨ IMPROVED: Scale and fade entrance
        enter: Transition {
            NumberAnimation {
                property: "opacity"
                from: 0
    ...
    // --- Enhanced Wallpaper Card Component ---
    component WallpaperCard: Rectangle {
        ...
        Image {
            ...
            anchors.fill: parent
            anchors.margins: 2
            source: card.wallpaperPath
            fillMode: Image.PreserveAspectCrop
            asynchronous: true
            
            // ✨ IMPROVED: Fade in when loaded
        ...
        // Name overlay with slide-up animation
        Rectangle {
            id: nameOverlay
        ...
        // ✨ IMPROVED: Elastic scale with spring physics
        ...
        // ✨ IMPROVED: Subtle rotation on hover
    ...
    // --- Enhanced Dialog Button Component ---
    component DialogButton: Rectangle {
        ...
        // ✨ IMPROVED: Smooth color transition
        Behavior on color { 
            ColorAnimation { duration: 250 } 
        }
