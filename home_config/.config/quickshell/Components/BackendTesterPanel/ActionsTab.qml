...
ColumnLayout {
  ...
  signal sendAction(string module, var actionPayload)
  ...
  Flow {
    ...
    Repeater {
      ...
      delegate: Rectangle {
        ...
        height: 36
        radius: 18
        color: actionBtnArea.containsMouse ? Qt.rgba(Th.Theme.primary.r, Th.Theme.primary.g, Th.Theme.primary.b, 0.2) : Qt.rgba(Th.Theme.primary.r, Th.Theme.primary.g, Th.Theme.primary.b, 0.08)
        border.width: 1
        ...
        Row {
          ...
          Rectangle {
            ...
            height: 6
            radius: 3
            color: actionBtn.modelData.argsHint !== "" ? Th.Theme.warning : Th.Theme.success
          }
        ...
        MouseArea {
          ...
          onClicked: {
            if (actionBtn.modelData.argsHint !== "") {
              try {
                let args = JSON.parse(actionBtn.modelData.argsHint);
                let payload = {};
                payload[actionBtn.modelData.name] = args;
                actionsTabRoot.sendAction(actionsTabRoot.selectedModule, payload);
              } catch (e) {
                actionsTabRoot.sendAction(actionsTabRoot.selectedModule, actionBtn.modelData.name);
              }
            } else {
              actionsTabRoot.sendAction(actionsTabRoot.selectedModule, actionBtn.modelData.name);
            }
    ...
    ColumnLayout {
      ...
      RowLayout {
        ...
        Rectangle {
          ...
          Layout.preferredHeight: 36
          radius: 18
          color: ssidInput.text.length > 0 ? Qt.rgba(Th.Theme.primary.r, Th.Theme.primary.g, Th.Theme.primary.b, 0.25) : Qt.rgba(Th.Theme.fg.r, Th.Theme.fg.g, Th.Theme.fg.b, 0.05)
          border.width: 1
          border.color: ssidInput.text.length > 0 ? Qt.rgba(Th.Theme.primary.r, Th.Theme.primary.g, Th.Theme.primary.b, 0.4) : Qt.rgba(Th.Theme.fg.r, Th.Theme.fg.g, Th.Theme.fg.b, 0.1)
          ...
          MouseArea {
            ...
            onClicked: {
              if (ssidInput.text.length > 0) {
                actionsTabRoot.sendAction(actionsTabRoot.selectedModule, {
                  "type": "connect",
                  "ssid": ssidInput.text
                });
                ssidInput.text = "";
