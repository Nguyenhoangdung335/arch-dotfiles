...
Rectangle {
    ...
    ColumnLayout {
        ...
        GridLayout {
            ...
            Text { text: "Signal:"; color: Th.Theme.fg; opacity: 0.7 }
            Text { 
                text: root.networkData ? root.networkData.strength + "%" : "-"
                color: Th.Theme.fg 
            }
            
            Text { text: "Security:"; color: Th.Theme.fg; opacity: 0.7 }
            Text { text: "WPA2/3"; color: Th.Theme.fg } // Mocked
            
            Text { text: "Freq:"; color: Th.Theme.fg; opacity: 0.7 }
            Text { text: "5 GHz"; color: Th.Theme.fg } // Mocked
        }
