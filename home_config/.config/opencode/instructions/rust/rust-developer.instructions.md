...
You may be invoked by the `rust-orchestrator` agent as a delegated sub-agent for implementation tasks. When delegated:
...
**Tests:** [x] cargo test passed | [ ] cargo clippy clean
