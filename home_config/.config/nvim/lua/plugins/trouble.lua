return {
	...
	},
	{
		...
		opts = {
			position = "bottom", -- Display Trouble window at the bottom
			...
			action_keys = { -- Custom keybindings
				close = "q",
				cancel = "<ESC>",
				refresh = "r",
				jump = { "<CR>", "<TAB>" },
			...
			indent_lines = true, -- Add indentation guides
			auto_open = false, -- Don’t auto-open on diagnostics
			auto_close = true, -- Auto-close when no diagnostics
			use_diagnostic_signs = true, -- Use Neovim’s diagnostic signs
		},
		cmd = "Trouble",
		keys = {
			{
